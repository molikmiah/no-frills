...
var appRouter = (function () {
    ...
    function _loadPage (param, bootstrapId) {
        ...
        if (typeof requestedRouteObject.templateUrl !== 'undefined') {
            _getTemplate(requestedRouteObject, bootstrapId);
        }
     ...
     * @param {string} routeData.templateUrl This routeData object contains the filePath and data
     */
    function _getTemplate(routeData, bootstrapId) {
        ...
        xhr.onreadystatechange= function() {
            ...
            // // var templateContents = $('#tplContent').html();
            // var popupTemplate = _.template(this.responseText);
            // var rendered = popupTemplate(routeData.controller);

            // // $(bootstrapId).html(rendered);
            ...
            // Mustache.parse(this.responseText);   // optional, speeds up future uses
            var rendered = Mustache.render(this.responseText, routeData.controller);
